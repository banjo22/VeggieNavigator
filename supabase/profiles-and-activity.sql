create table if not exists public.profiles (
  ...
  avatar_url text,
  premium_status text not null default 'free' check (premium_status in ('free', 'trialing', 'active', 'past_due', 'canceled')),
...
create table if not exists public.spot_comments (
  ...
  body text not null,
  parent_comment_id bigint references public.spot_comments(id) on delete cascade,
